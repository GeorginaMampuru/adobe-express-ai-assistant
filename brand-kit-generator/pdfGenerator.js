  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      sections.forEach((section, i) => {
        const pageNum = i < 6 ? i + 3 : i + 4; // Adjust for new template section
      ...
      addTemplateSection(doc, brandData); // New template section
...
function addColorSection(doc, brandData) {
  ...
  // Color usage guidelines with visual examples
  doc.fontSize(14)
...
function addTypographySection(doc, brandData) {
  ...
  // Heading styles with visual hierarchy example
  doc.fontSize(14)
  ...
  doc.font(brandData.fonts.body)
     .fillColor('#333333')
     .fontSize(12)
     .text('This is how your body text appears when paired with headings. The combination creates visual hierarchy and brand consistency. Use this format for all long-form content to maintain a professional yet approachable tone.', 
...
function addTemplateSection(doc, brandData) {
  ...
  // Template 2: Business Presentation
  doc.fontSize(16)
     .fillColor(brandData.colors.primary)
